			...
			<div class="col-md-4">
				<div class="dialog dialog-danger">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
						<input type="text" placeholder="Enter your name/email" name="name" class="form-control flat input-md">
						</div>
						<div class="col-md-2">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-5">
						<a href="./thankyou.php" class="btn btn-success btn-embossed">Submit</a>
						</div>
						<div class="col-md-5">
						<a href="./login_help.php" class="btn btn-inverse btn-embossed">Back</a>
						</div>
						<div class="col-md-1">
						</div>
					</div>
